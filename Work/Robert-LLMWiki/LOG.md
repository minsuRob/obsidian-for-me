...
## [2026-07-08] query | "1000배 생산성이란?" 정리
- [[AI 시대 개발자 성장]]에 "핵심 발견 6 — 곱셈의 해부(속도×병렬성×야망), 상한=판단·검증" 섹션 추가

## [2026-07-11] ingest | 일감 전면 교체 (사용자 지시)
- 기존 일감 7개 삭제: 모바일 컴포저 멘션, 웹 assign 일감 언급, Mac 빌드 워크트리 유일성 검증, Unread 이슈, Electron 버전 통일, 채팅창 Ctrl+Z 미동작, 이모지 Detail View.
- 신규 일감 3개(중간 우선순위) 생성: [[애플워치에 화면 연동하기]], [[오픈 헤르메스 개발]], [[LLM 공부]].
- [[멘션 인프라 (Lexical)]]의 삭제된 일감 링크를 플레인 텍스트로 정리해 깨진 링크 방지.
- INDEX.md 일감 표 교체.

## [2026-07-27] lint | 개념 페이지 2개 삭제 (사용자 지시)
- 삭제: 멘션 인프라 (Lexical), MAKi MCP 메시지 포맷. (7/3 데일리노트가 참조하던 개념 페이지)
- INDEX.md 개념 섹션 비움("아직 없음"). raw/daily/2026-07-03.md 링크는 원본이라 미수정(깨진 링크로 남음).
